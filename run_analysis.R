...
setwd("C:/COURSE_PROJECT_CLEAN_DATA")

#download data set
library(httr) 
url <- "https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
file <- "FUCI_HARD_Dataset.zip"
if(!file.exists(file)){
  print("Featching requred data ...")
  download.file(url, file, method="curl")
}

#unziping archive and creating necessery folders
...
saveresults <- function (data,name){
  print(paste("Saving results to ", name))
...
### FINAL ANOUNCMENT ###
print("Results was saved in CSV file named: tidy_dataset.csv")
